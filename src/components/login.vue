                ...
                <div style="width: 30%">
                    ...
                    <p>
                        <a-input 
                            ...
                            @focus="validate.username = false, validate.passWrong = false"
                            @change="validate.username = false, validate.passWrong = false"
                            @blur="validate.username = false, validate.passWrong = false"
                    ...
                    <p>
                        <a-input-password
                            ...
                            @focus="validate.password = false, validate.passWrong = false"
                            @change="validate.password = false, validate.passWrong = false"
                            @blur="validate.password = false, validate.passWrong = false"
                            @keypress.native="eventEnterLogin" 
                            ref="inputPassword"
                        ></a-input-password>
                    ...
                    <div class="text-forget-password" @click="forgetPassword">
                        ลืมรหัสผ่าน ?
                    </div>
